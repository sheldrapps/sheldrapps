    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: {
            startPostBootstrapSync: jasmine.createSpy('startPostBootstrapSync'),
          },
        },
        {
        ...
        },
        {
          ...
          useValue: {
            ...
            instant: jasmine.createSpy('instant').and.returnValue('ECC'),
        ...
        {
          provide: EccLifecycleDiagnosticsService,
