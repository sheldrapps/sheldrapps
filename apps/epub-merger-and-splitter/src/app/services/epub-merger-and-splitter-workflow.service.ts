...
import {
  ...
  EpubFixerNativeService as EpubMergerAndSplitterNativeService,
...
export class EpubMergerAndSplitterWorkflowService {
  readonly maxNativeSizeMB = 1024;
  readonly recommendedWebSizeMB = 50;

  private readonly port = inject(EPUB_MERGER_AND_SPLITTER_PORT);
  private readonly nativePicker = inject(EpubMergerAndSplitterNativeService);
