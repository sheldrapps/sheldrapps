...
import { PdfMergerAndSplitterSettings } from 'src/app/settings/pdf-merger-and-splitter-settings.schema';
...
export class SettingsPage {
  ...
  readonly privacyPolicyUrl =
    'https://sheldrapps.com/privacy-policies/pdf-merger-and-splitter';
