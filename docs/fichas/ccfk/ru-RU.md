# Cover Creator for Kindle - ru-RU Ficha Play Store

## Propósito

Definir la estrategia creativa y comercial de la ficha de Play Store para el locale ru-RU, manteniendo texto localizado solo dentro de bloques Copy visible.

## Nombre de la app

Copy visible:
- nombre actual: Создать обложки для Kindle
- nombre sugerido, si aplica: Создать обложки для Kindle
...
Copy visible:
- SEO-first: Создавайте персональные обложки Kindle из любимых изображений
- Conversion-first: Сделайте Kindle более личным с любым изображением
- Balanced: Превратите любимое изображение в обложку Kindle
- Texto seleccionado: Превратите любимое изображение в обложку Kindle
...
Copy visible:
Сделайте Kindle более личным, красивым и вашим.

Создать обложки для Kindle помогает превращать уже имеющиеся изображения в персональные обложки для Kindle и других поддерживаемых e-reader. Используйте любимое фото, снимок питомца, воспоминание о поездке, иллюстрацию, цифровой арт или любой другой визуальный образ, который соответствует вашему чтению.

Вместо того чтобы угадывать размер, вы выбираете модель устройства и проверяете результат перед сохранением. Процесс простой и визуальный: выбрать изображение, подправить кадрирование, посмотреть предпросмотр и создать результат, который готов к использованию.

Подходит для уютных Kindle-обложек, уже имеющихся иллюстраций и арта, фото питомцев, дорожных снимков, спокойного читательского настроения, минималистичных сетапов, а также для обложек Kindle, Kobo, Nook, PocketBook, Tolino и других устройств.

Суть проста: взять изображение, которое уже кажется вашим, и сделать так, чтобы оно хорошо смотрелось на Kindle или e-reader.

Создать обложки для Kindle не является официальным приложением Amazon, Kindle, Kobo или других брендов. Названия брендов используются только для описания совместимых моделей и сценариев работы.
...
Paleta:
- fondo principal: #0B1524
- fondo secundario: #172A3D
- acento: #A9724F
- acento cálido/frío opcional: #7BA3BE
- color de titular: #FFFFFF
- color de subtítulo: #DCE5EE
...
Copy visible:
- titulo: ПОКАЗАТЬ KINDLE-COVER СРАЗУ
- subtítulo: Фото, иллюстрации и bookish images
- bullets:

  - Kindle, Kobo, Nook и др.
  - Для E-Ink экранов
  - Обрезка, предпросмотр, экспорт
...
- base principal: #0B1524
- secundario: #172A3D usado como una transición suave y premium
- acento: #A9724F
...
Copy visible:
- titulo: Сделайте Kindle более личным
- subtítulo: Любимое изображение может стать обложкой
...
- base principal: #0B1524
- secundario: #172A3D usado como un fondo premium de apoyo
- acento: #A9724F
...
Copy visible:
- titulo: От изображения к обложке Kindle
- subtítulo: Подгоните любимое фото под экран
...
fondo:
- dimension: 1994x3456 px
- base principal: #172A3D
- secundario: #0B1524 usado para dar profundidad
- acento: #7BA3BE
...
Copy visible:
- titulo: Стиль, похожий на вас
- subtítulo: Подберите настроение под книги, стол или день
...
- dimension: 1994x3456 px
- base principal: #0B1524
- secundario: #172A3D usado como una transición calmada
- acento: #A9724F
...
Copy visible:
- titulo: Обрезать, настроить, посмотреть
- subtítulo: Проверьте перед сохранением
...
- dimension: 1994x3456 px
- base principal: #172A3D
- secundario: #0B1524 usado para profundidad
- acento: #7BA3BE
...
Copy visible:
- titulo: Для Kindle, Kobo и других
- subtítulo: Выберите модель и получите правильный размер
...
- dimension: 1994x3456 px
- base principal: #0B1524
- secundario: #172A3D usado como gradiente técnico suave
- acento: #A9724F
