...
## Purpose
Localized Play Store listing for en-US, regenerated for CCFK with Kindle-first conversion and new image|scratch source flow.
...
Primary user desire:
Create personal Kindle/e-reader cover from image or scratch in seconds.
