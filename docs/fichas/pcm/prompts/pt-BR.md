...
Source ficha: `docs/fichas/pcm/pt-BR.md`
...
titulo:
CRIE CAPAS DE PDF MELHORES

subline:
Escolha uma imagem, ajuste e salve
...
* Capas de PDF personalizadas
* Processamento no dispositivo
* Salvar uma nova cópia
...
titulo:
SEU PDF ESTÁ SIMPLES DEMAIS?

subline:
Crie uma capa melhor em segundos
...
Source ficha: `docs/fichas/pcm/pt-BR.md`
Source screenshot: `tools/playstore/raw/pcm/pt-BR/02-color-source.png`

Generate image.

Use my screenshot in your composition. Only replace the pattern/image area inside the editor with an image input that a target PDF user could use.
...
Source ficha: `docs/fichas/pcm/pt-BR.md`
Source screenshot: `tools/playstore/raw/pcm/pt-BR/03-editor-loaded.png`
...
titulo:
ENQUADRE DO SEU JEITO

subline:
Controle o corte e o layout
...
Source ficha: `docs/fichas/pcm/pt-BR.md`
Source screenshot: `tools/playstore/raw/pcm/pt-BR/04-preview-final.png`

Generate image.

Use my screenshot in your composition. Only replace the content of the PDF card, the PDF name, and the filename.
...
Source ficha: `docs/fichas/pcm/pt-BR.md`
Source screenshot: `tools/playstore/raw/pcm/pt-BR/05-library-updated.png`

Generate image.

Use my screenshot in your composition. Only replace the PDF name and the thumbnail image.
...
Source ficha: `docs/fichas/pcm/pt-BR.md`
Source screenshot: `tools/playstore/raw/pcm/pt-BR/06-save-copy-success.png`
