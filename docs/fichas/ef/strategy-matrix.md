...
EPUB Fixer diagnoses common supported EPUB structure issues, repairs compatible problems, explains the result, and saves a repaired EPUB as a new copy without changing the original file.

## Global Strategy

The core conversion journey is:

**EPUB with a problem → clear diagnosis → supported repair → repaired copy → local privacy**
...
The screenshot sequence must follow:
...
Use this sequence unless a locale-specific conversion reason requires adjustment:

1. EPUB problem → repaired copy
2. Understand what failed
3. Repair supported issues
4. Review what was repaired
5. Save a new repaired copy
6. 100% on your device
